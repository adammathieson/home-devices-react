...
useEffect(() => {
    const rLeg = gsap.TweenMax.fromTo("#leg-right", .5, {rotate: 6}, {rotate: -6, ease:'none', repeat:-1, yoyo: true});
    rLeg.progress(0.5).pause();
    rLeg.play();
    
    const lLeg = gsap.TweenMax.fromTo("#leg-left", .5, {rotate: -6}, {rotate: 6, ease:'none', repeat:-1, yoyo: true});
    lLeg.progress(0.5).pause();
    lLeg.play();
    
    const rLegBack = gsap.TweenMax.fromTo("#leg-right-back", .5, {rotate: 6}, {rotate: -6, ease:'none', repeat:-1, yoyo: true});
    rLegBack.progress(0.5).pause();
    rLegBack.play();
    
    const lLegBack = gsap.TweenMax.fromTo("#leg-left-back", .5, {rotate: -6}, {rotate: 6, ease:'none', repeat:-1, yoyo: true});
    ...
    const tl = gsap.timeline()
        ...
        // tl.to("#bg-houses", {x: -60, duration: 6, ease: none}, "-=1.5")
        // tl.to("#foreground", {x: -650, duration: 6, ease: none}, "-=6")
            ...
            <g id="scene-1-exterior" clip-path="url(#clip0)">
                    ...
                    <g id="bg-houses">
                        ...
                        <g id="house-bg_7">
                            ...
                            <path id="Rectangle 361_7"
                                ...
                                fill="#B1BEFF" stroke="#798FFF" />
                            <path id="Rectangle 362_7"
                        ...
                        <g id="bg-house-2">
                            ...
                            <path id="Polygon 5" d="M340.18 250.801l26.147 6.912v2.225h-52.294v-2.225l26.147-6.912z"
                                fill="#E79898" />
                            <path id="Polygon 6" fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <g id="bg-house-2_2">
                            ...
                            <path id="Polygon 5_2" d="M859.298 255.406l23.287 6.912v2.225H836.01v-2.225l23.288-6.912z"
                                fill="#423B3B" />
                            <path id="Polygon 6_2" fill-rule="evenodd" clip-rule="evenodd"
                ...
                <g id="foreground">
                    <g id="sidewalk">
                        ...
                        <path id="Vector 13" d="M477.484 528.26l-7.24 66.958" stroke="#868DB3" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" />
                        <path id="Vector 14" d="M320.543 528.521l-7.24 66.958" stroke="#868DB3" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" />
                        <path id="Vector 15" d="M163.601 528.781l-7.239 66.958" stroke="#868DB3" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" />
                        <path id="Vector 16" d="M6.66 529.042L-.58 596" stroke="#868DB3" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path id="Vector 17" d="M626.952 528.521l-7.24 66.958" stroke="#868DB3" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" />
                        <path id="Vector 18" d="M774.085 528l-7.24 66.958" stroke="#868DB3" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" />
                    </g>
                    <g id="house-main">
                        ...
                        <g id="door">
                            ...
                            <path id="door_2" fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <path id="railing" fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <path id="railing_2" fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <g id="double-window_2">
                            ...
                            <g id="Group 4_2">
                                ...
                                <path id="Rectangle 524_6" transform="matrix(0 1 1 0 351.773 230.281)" fill="#B6C3DD"
                                    d="M0 0h5.116v34.06H0z" />
                                <path id="Subtract_6" fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <g id="wyze-cam">
                            <g id="camera-wall">
                                ...
                                <path id="Subtract_7" fill-rule="evenodd" clip-rule="evenodd"
