    ...
    <g id="scene-1-exterior" clip-path="url(#clip0)">
        ...
        <g id="foreground">
            ...
            <g id="house-main">
                ...
                <g id="door">
                    ...
                    <g id="keypad">
                        <g id="product-display" display="none">
                            ...
                            <path id="product-info" fill="#333" d="M435 309h80v43.667h-80z" />
                            <path id="product-info_2" fill="#333" d="M435 367h80v39h-80z" />
                            <g id="product-card" display="none">
                                <g id="product-title">
                ...
                <g id="wyze-cam">
                    <g id="product-display_2" display="none">
                        ...
                        <g id="product-card_2" display="none">
                            <g id="product-title_2">
                                <path id="Wyze Cam V2"
